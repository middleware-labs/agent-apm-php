...
final class MwTracker
{
  ...
  public function __construct(string $projectName = null, string $serviceName = null)
  {
    ...
    // Use OtlpHttpTransportFactory instead of StreamTransportFactory
    ...
    // Use the Logger directly without the EventLogger wrapper
    // Since we're having issues with the EventLogger constructor
  ...
  private function logging(string $type, int $number, string $text): void
  {
    ...
    // Using logger directly instead of EventLogger
